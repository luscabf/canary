...
local config = {
	...
	[34258] = {NAME = 'White Lion', ID = 174, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 40, FAIL_MSG = { {1, 'The white lion majestically reject the flower.'}, {2, 'The white lion fled.'}, {3, 'The white lion ran away.'} }, SUCCESS_MSG = 'You have tamed the white lion.', ACHIEV = "Well Roared, Lion!"},
